...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-vg^0g-^%3zv=hsv8l-g42$-d@3b)k9u!9=oz4jts*sfj%kt!an')
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME') if os.environ.get('DB_NAME') else os.path.join(BASE_DIR, 'db.sqlite3'),
...
# Additional directories where Django will look for static files (if any)
STATICFILES_DIRS = [
